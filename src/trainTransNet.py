...
modelfn = 'output/model-data%s-%s_of_TransNet.pth' % (seqid, c_time)

print('#building model ...')
print('#model: TransNet(depth=6, width=512)')
...
class TransNet(nn.Module):
    def __init__(self, depth, width, dropout = 0.1):
        ...
        self.pos_embed = PositionEncode(1000+1,width)
...
model = TransNet(depth=6, width=512).cuda()
